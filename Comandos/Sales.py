...
#Si queremos saber por ejemplo el promedio de ganacias en el grupo de (35-64) años
#Usamos el comando loc
sales.loc[sales['Age_Group']== 'Adults (35-64)','Revenue'].mean()

#Le podemos ir agregando mas condiciones (Condicion O)
sales.loc[(sales['Age_Group']== 'Youth (<25)')|(sales['Age_Group']=='Adults (35-64)')].shape[0]

#Le podemos ir agregando mas condiciones (Condicion Y)
sales.loc[(sales['Age_Group']== 'Youth (<25)') & (sales['Country']=='United States'),'Revenue'].mean()

sales.loc[(sales['Age_Group']== 'Adults (35-64)') & (sales['Country']=='United States'),'Revenue'].mean()

#Si queremos filtrar y modicar ciertos valores, lo hacemos de la siguiente manera
